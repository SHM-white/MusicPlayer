...
./linuxdeploy --appdir AppDir --executable AppDir/usr/bin/MusicPlayer --desktop-file AppDir/usr/share/applications/MusicPlayer.desktop --output appimage --library /usr/lib/x86_64-linux-gnu/libstdc++.so.6 /usr/lib/x86_64-linux-gnu/libc.so.6 --plugin qt